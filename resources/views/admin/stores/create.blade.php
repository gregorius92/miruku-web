...
<div class="w-full">
    ...
    <form action="{{ route('admin.stores.store') }}" method="POST" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
        ...
        <div class="grid sm:grid-cols-2 gap-4">
            ...
            <input type="hidden" name="city_en" id="city_en_hidden">
            <div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // Intercept form submission to send Province Name instead of ID
        $('form').on('submit', function(e) {
            ...
            if (provinceId) {
                ...
                $provinceSelect.attr('name', ''); // Remove original so it doesn't send ID
            }
        });
