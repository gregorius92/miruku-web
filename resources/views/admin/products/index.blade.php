...
<div class="flex items-center justify-between mb-6">
    <div>
        ...
        <p class="text-sm text-gray-500 mt-1">Kelola semua produk Miruku</p>
    </div>
    ...
    <table class="w-full text-sm">
        <thead class="bg-gray-50 border-b border-gray-100">
            <tr>
                ...
                <th class="text-left px-5 py-3.5 font-semibold text-gray-600">Harga</th>
                <th class="text-left px-5 py-3.5 font-semibold text-gray-600">Stok</th>
            ...
            <tr class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-5 py-4 text-right">
                    <div class="flex items-center justify-end gap-2">
                        <a href="{{ route('admin.products.edit', $product) }}" class="text-xs text-blue-600 hover:text-blue-700 font-medium px-3 py-1.5 rounded-lg hover:bg-blue-50 transition-colors">Edit</a>
