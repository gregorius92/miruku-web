    ...
    <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-5">
        ...
        <div class="grid sm:grid-cols-2 gap-5">
            <div class="sm:col-span-2 space-y-4">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $product->getRawOriginal('name')) }}" required class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-miruku-blue">
                </div>
                <div>
                    ...
                    <input type="text" name="name_en" value="{{ old('name_en', $product->name_en) }}" class="w-full border border-blue-100 bg-blue-50/20 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-miruku-blue" placeholder="Product Name in English">
                </div>
            </div>
            <div>
        ...
        <div class="grid sm:grid-cols-2 gap-5">
            <div>
                ...
                <textarea name="description" rows="3" class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-miruku-blue resize-none">{{ old('description', $product->getRawOriginal('description')) }}</textarea>
            </div>
            <div>
                <label class="block text-sm font-semibold text-blue-600 mb-1.5 flex items-center gap-1.5">
                    <span class="w-2 h-2 rounded-full bg-blue-500"></span>
                ...
                <textarea name="description_en" rows="3" class="w-full border border-blue-100 bg-blue-50/20 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-miruku-blue resize-none" placeholder="Short description in English">{{ old('description_en', $product->description_en) }}</textarea>
            </div>
        </div>
        ...
        <div class="space-y-4">
            <div>
                ...
                <textarea name="body" rows="6" class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-miruku-blue font-mono resize-y">{{ old('body', $product->getRawOriginal('body')) }}</textarea>
            </div>
            <div>
                <label class="block text-sm font-semibold text-blue-600 mb-1.5 flex items-center gap-1.5">
                    <span class="w-2 h-2 rounded-full bg-blue-500"></span>
                ...
                <textarea name="body_en" rows="6" class="w-full border border-blue-100 bg-blue-50/20 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-miruku-blue font-mono resize-y" placeholder="Full content in English">{{ old('body_en', $product->body_en) }}</textarea>
            </div>
        </div>
        ...
        <div class="border-t border-gray-100 pt-5 mt-5">
            ...
            <div class="grid sm:grid-cols-2 gap-5 mb-5">
                <div>
                    ...
                    <input type="text" name="meta_title" value="{{ old('meta_title', $product->getRawOriginal('meta_title')) }}" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-miruku-blue">
                </div>
                <div>
                    <label class="block text-sm font-medium text-blue-500 mb-1">Meta Title (EN)</label>
                    <input type="text" name="meta_title_en" value="{{ old('meta_title_en', $product->meta_title_en) }}" class="w-full border border-blue-100 bg-blue-50/20 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-miruku-blue">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-600 mb-1">Meta Description (ID)</label>
                    <textarea name="meta_description" rows="2" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-miruku-blue resize-none">{{ old('meta_description', $product->getRawOriginal('meta_description')) }}</textarea>
                </div>
                <div>
                    <label class="block text-sm font-medium text-blue-500 mb-1">Meta Description (EN)</label>
                    <textarea name="meta_description_en" rows="2" class="w-full border border-blue-100 bg-blue-50/20 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-miruku-blue resize-none">{{ old('meta_description_en', $product->meta_description_en) }}</textarea>
                </div>
            </div>
        </div>
