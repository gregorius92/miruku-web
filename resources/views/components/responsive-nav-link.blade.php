...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-miruku-blue text-left text-base font-medium text-miruku-dark bg-blue-50 focus:outline-none focus:text-miruku-dark focus:bg-blue-100 focus:border-miruku-dark transition duration-150 ease-in-out'
