<nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300"
    ...
    <div x-show="mobileMenu"
        ...
        <div class="max-w-7xl mx-auto px-4 py-6 space-y-4">
            <a href="{{ route('home') }}" class="block text-white/90 font-medium py-2 hover:text-white transition-colors">Beranda</a>
            <a href="{{ route('products.index') }}" class="block text-white/90 font-medium py-2 hover:text-white transition-colors">Produk</a>
            <a href="{{ route('about') }}" class="block text-white/90 font-medium py-2 hover:text-white transition-colors">Tentang</a>
            <a href="{{ route('benefits') }}" class="block text-white/90 font-medium py-2 hover:text-white transition-colors">Manfaat</a>
